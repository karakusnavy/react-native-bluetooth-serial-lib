...
public class RCTBluetoothSerialModule extends ReactContextBaseJavaModule implements ActivityEventListener, LifecycleEventListener {
    ...
    private RCTBluetoothClassic mBluetoothClassic;
    ...
    public RCTBluetoothSerialModule(ReactApplicationContext reactContext) {
        ...
        if (mBluetoothClassic == null) {
            mBluetoothClassic = new RCTBluetoothClassic(reactContext);
        }
     ...
     * Enable bluetooth
     */
    public void connectClient(Promise promise) {
        mBluetoothClassic.clientServer();
        promise.resolve(true);
    }
